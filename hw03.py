...
def pingpong(n):
    ...
    def helper(i, dir, val):
        if i == n:
            return val + dir
        elif num_eights(i) >= 1 or i%8 == 0:
            return helper(i+1,-dir,val+dir)
        else:
            return helper(i+1, dir, val+dir)
...
def missing_digits(n):
    ...
    if n<10:
        return 0
    elif n%10 == (n//10)%10 or n%10 == ((n//10)%10)-1:
...
def count_coins(change):
    ...
    def helper(cg,coin):
        if cg == 0:
            ...
            return helper(cg-coin,coin) + helper(cg,ascending_coin(coin)) 
